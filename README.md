...
For over 9 years, I built and ran my own beauty business in Brazil, managing daily operations and a growing team across two locations. Before that, I spent more than 2 years in judicial and administrative roles within Rio de Janeiro's justice system, handling legal documentation, case files, and institutional processes. Both experiences sharpened the same core skills I bring to testing today: precise documentation, process management, and catching inconsistencies before they become bigger problems. I'm currently completing a hands-on QA training program with TripleTen — this portfolio documents that journey.
...
|---|---|---|---|---|
| 🧪 Urban Routes – Regression Testing | Manual Testing, Regression Testing, Bug Reporting | [Read](details/sprint-1-summary.md) | [View](details/sprint-1-feedback.md) | ✅ Completed |
| 📋 Test Documentation | Requirements Analysis, Boundary Value Analysis | [Read](details/sprint-2-summary.md) | [View](details/sprint-2-feedback.md) | ✅ Completed |
| 🐞 Manual Testing & Bug Reporting | UI Testing, Bug Reporting, Jira | [Read](details/sprint-3-summary.md) | [View](details/sprint-3-feedback.md) | ✅ Completed |
...
8. **Apply feedback to improve my process** — I treat reviewer feedback as part of the testing process itself, not just a grade. Each round of feedback has directly shaped how I approach the next project — as documented in each project's feedback page above.
